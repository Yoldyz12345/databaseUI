...
define("EW_PROJECT_ID", "{AD4C364C-5CB3-430F-AF23-10EA2887A04D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'nw26vXVpVkDQk7Tt', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "POSTGRESQL", "host" => "dblp.cqpsthbtxkwu.us-west-2.rds.amazonaws.com", "port" => 5432, "user" => "aby", "pass" => "yulduz", "db" => "databaseDMD", "qs" => "\"", "qe" => "\"");
...
define("EW_IS_POSTGRESQL", TRUE, TRUE); // PostgreSQL
