...
$article_view = NULL; // Initialize page object first

class carticle_view extends carticle {
	...
	function __construct() {
		...
		if (@$_GET["publication_id"] <> "") {
			$this->RecKey["publication_id"] = $_GET["publication_id"];
			$KeyUrl .= "&amp;publication_id=" . urlencode($this->RecKey["publication_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["publication_id"] <> "") {
				...
				$this->RecKey["publication_id"] = $this->publication_id->QueryStringValue;
			} elseif (@$_POST["publication_id"] <> "") {
				$this->publication_id->setFormValue($_POST["publication_id"]);
				$this->RecKey["publication_id"] = $this->publication_id->FormValue;
			} else {
				$sReturnUrl = "articlelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "articlelist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "articlelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($article_view)) $article_view = new carticle_view();
...
var CurrentForm = farticleview = new ew_Form("farticleview", "view");

// Form_CustomValidate event
farticleview.Form_CustomValidate = 
...
farticleview.ValidateRequired = true;
<?php } else { ?>
farticleview.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="farticleview" id="farticleview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($article_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $article_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="article">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($article->publication_id->Visible) { // publication_id ?>
	<tr id="r_publication_id">
		<td><span id="elh_article_publication_id"><?php echo $article->publication_id->FldCaption() ?></span></td>
...
<?php echo $article->publication_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($article->title->Visible) { // title ?>
	<tr id="r_title">
		<td><span id="elh_article_title"><?php echo $article->title->FldCaption() ?></span></td>
...
<?php echo $article->title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($article->pages->Visible) { // pages ?>
	<tr id="r_pages">
		<td><span id="elh_article_pages"><?php echo $article->pages->FldCaption() ?></span></td>
...
<?php echo $article->pages->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($article->volume->Visible) { // volume ?>
	<tr id="r_volume">
		<td><span id="elh_article_volume"><?php echo $article->volume->FldCaption() ?></span></td>
...
<?php echo $article->volume->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($article->journal_id->Visible) { // journal_id ?>
	<tr id="r_journal_id">
		<td><span id="elh_article_journal_id"><?php echo $article->journal_id->FldCaption() ?></span></td>
...
<?php echo $article->journal_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
